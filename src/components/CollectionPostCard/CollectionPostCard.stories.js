...
export default {
  title: 'sections/CollectionPostCard',
...
const Template = (args) => <CollectionPostCard {...args} />;

export const WhitTitleAndButton = Template.bind({});
WhitTitleAndButton.args = {
  posts: [
    {
...
export const WhitoutTitleAndButton = Template.bind({});
WhitoutTitleAndButton.args = {
  posts: [
    {
      contentTypeName: 'journeys',
      id: 'cG9zdDo5OQ==',
